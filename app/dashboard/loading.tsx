    ...
    <div className="min-h-screen" style={{ background: "var(--bg-base)" }}>
      ...
      <div className="max-w-2xl mx-auto px-5 py-7">
        <div className="mb-6 space-y-2">
          <div className="w-40 h-7 rounded-xl animate-pulse" style={{ background: "var(--bg-subtle)" }} />
        ...
        <div className="flex flex-col gap-2">
          {[...Array(6)].map((_, i) => (
            ...
            >
              <div className="w-[34px] h-[34px] rounded-lg shrink-0" style={{ background: "var(--bg-subtle)" }} />
